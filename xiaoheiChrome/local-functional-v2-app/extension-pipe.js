...
async function launchPipeBrowser(browserPath, args, windowsHide = false) {
  const child = spawn(browserPath, args, { windowsHide, stdio: ['ignore', 'ignore', 'ignore', 'pipe', 'pipe'] });
...
module.exports = { PipeConnection, launchPipeBrowser, launchInstaller, closeInstaller, reconcileOnConnection, reconcileUnpackedExtensions };
