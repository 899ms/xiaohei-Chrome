...
function download(url, redirects = 0) {
  ...
  return new Promise((resolve, reject) => {
    const request = https.get(parsed, { headers: { 'user-agent': 'Mozilla/5.0 BrowserOpsLocal/3.0' }, timeout: 25000 }, (response) => {
