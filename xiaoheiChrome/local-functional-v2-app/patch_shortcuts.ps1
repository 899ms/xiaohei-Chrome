...
$main = Replace-Exact $main "const { app, BrowserWindow, dialog, ipcMain, screen, session } = require('electron');" "const { app, BrowserWindow, dialog, globalShortcut, ipcMain, screen, session } = require('electron');" 'electron import'
