...
async function main() {
  ...
  const lists = new Map([
    [1, [tab('m1', 'file:///browserops-start.html'), tab('m2', 'https://example.test/arcus')]],
    [2, [tab('s21', 'file:///browserops-start.html'), tab('s22', 'https://example.test/arcus'), tab('s2x1', 'about:blank'), tab('s2x2', 'about:blank')]],
    [3, [tab('s31', 'file:///browserops-start.html'), tab('s32', 'https://example.test/arcus'), tab('s3x1', 'about:blank'), tab('s3x2', 'about:blank')]],
    [4, [tab('s41', 'file:///browserops-start.html'), tab('s42', 'https://example.test/arcus'), tab('s4x1', 'about:blank'), tab('s4x2', 'about:blank')]],
  ]);
